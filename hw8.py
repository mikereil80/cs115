...
def test_compressA_and_uncompressA():
    '''Tests compressA and uncompressA against each other to ensure both
are working properly as they should be the inverses of one another'''
    assert(uncompressA(compressA('1110001111001010'))=='1110001111001010')
    assert(uncompressA(compressA('1'))=='1')
    assert(uncompressA(compressA('1010'))=='1010')
    assert(uncompressA(compressA('11111'))=='11111')
