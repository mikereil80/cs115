...
# Input: n
# Assume: n>= 0
# Output: Fibonacci sequnce from 0 to the nth integer in the sequence
#

00       read    r1        # Get n
01       setn    r2 0      # initialize r2
02       setn    r3 1      # initialize r3
03       sub     r11 r1 r3 # change r11 = r1 - 1
04       jeqzn   r1 17     # jump to line 17 if r1 = 0 
05       addn    r1 -1     # change r1 = r1 - 1
06       jnezn   r11 09    # jump to line 09 if r11 != 0
07       write   r2        # print r2
08       halt              # stop!
09       write   r2        # print r2
10       jeqzn   r1 17     # done if r1 is 0 jump to line 17
11       add     r4 r2 r3  # change r4 = r2 + r3
12       write   r3        # print r3
13       copy    r2 r3     # change r2 = r3
14       copy    r3 r4     # change r3 = r4 
15       addn    r1 -1     # change r1 = r1 - 1
16       jumpn   10        # jump to line 10
17       halt              # stop!
"""
